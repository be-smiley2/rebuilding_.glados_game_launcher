...
class AutoUpdateManager:
    GITHUB_REPO = "be-smiley2/glados_game_launcher"
    ...
    def check_for_updates(self) -> UpdateCheckResult:
        ...
        try:
            ...
            if not match:
                return UpdateCheckResult(False, False, "Unable to determine remote version.", self.current_version, severity="error")
            ...
            sources = ", ".join(self.RAW_SCRIPT_URLS)
            return UpdateCheckResult(False, False, f"Update check failed: {exc}. Tried sources: {sources}", self.current_version, severity="error")
    ...
    def download_and_apply_update(self) -> UpdateApplyResult:
        ...
        try:
            ...
            if not self.remote_script:
                return UpdateApplyResult(False, "No update payload available.")
            ...
            sources = ", ".join(self.RAW_SCRIPT_URLS)
            return UpdateApplyResult(False, f"Update installation failed: {exc}. Tried sources: {sources}")
